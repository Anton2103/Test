...
<div class="cart-auto">
    <div class="cart-auto-wrapper">
        <div class="cart-auto-image">
            <img class="auto-img" src="<?php
            echo esc_url($img['url']); ?>" alt="<?php
            echo esc_attr($img['alt']); ?>"/>
        </div>
        <div class="cart-auto-content">
            <ul>
                <h3 class=""><span><?php
                        echo $brand, $model; ?></span></h3>
                <?php
                if (get_field('auto_sales')) {
                    ?><h3 class="">ПРОДАНО</h3><?php
                } ?>
                <li class=""> Рік випуску: <span style="font-weight:bold"> <?php
                        echo $year; ?> </span></li>
                <li class=""> Двигун: <span style="font-weight:bold"> <?php
                        echo $engine; ?> </span></li>
                <li class=""> Коробка передач: <span style="font-weight:bold"> <?php
                        echo $transmission; ?> </span></li>
                <li class=""> Привід: <span style="font-weight:bold"> <?php
                        echo $drive; ?> </span></li>
                <li class=""> Пробіг: <span style="font-weight:bold"> <?php
                        echo $mileage; ?> </span> км
                </li>
                <li class=""> Ціна: <span style="font-weight:bold"> <?php
                        echo $price; ?> </span> $
                </li>
            </ul>
        </div>
