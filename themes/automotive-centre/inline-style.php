<?php
	...
	$automotive_centre_nav_menus_font_weight = get_theme_mod( 'automotive_centre_navigation_menu_font_weight','Default');
    if($automotive_centre_nav_menus_font_weight == 'Default'){
		$automotive_centre_custom_css .='.main-navigation a{';
			$automotive_centre_custom_css .='';
		$automotive_centre_custom_css .='}';
	}else if($automotive_centre_nav_menus_font_weight == 'Normal'){
		$automotive_centre_custom_css .='.main-navigation a{';
			$automotive_centre_custom_css .='font-weight: normal;';
		$automotive_centre_custom_css .='}';
	}
	...
	$automotive_centre_featured_image_border_radius = get_theme_mod('automotive_centre_featured_image_border_radius', 0);
	if($automotive_centre_featured_image_border_radius != false){
		$automotive_centre_custom_css .='.box-image img, .feature-box img{';
			$automotive_centre_custom_css .='border-radius: '.esc_attr($automotive_centre_featured_image_border_radius).'px;';
		$automotive_centre_custom_css .='}';
	}
