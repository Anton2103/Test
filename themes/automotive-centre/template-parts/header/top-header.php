        ...
        <div class="row info-box">
          <?php if( get_theme_mod( 'automotive_centre_phone_text') != '' || get_theme_mod( 'automotive_centre_phone_number') != '') { ?>
            ...
            <div class="col-lg-10 col-md-12 col-9">
              ...
              <p><a href="tel:<?php echo esc_attr( get_theme_mod('automotive_centre_phone_number','') ); ?>"><?php echo esc_html(get_theme_mod('automotive_centre_phone_number',''));?></a></p>
            </div>
          <?php }?>
        </div>
      </div>
        ...
        <div class="row info-box">
          <?php if( get_theme_mod( 'automotive_centre_email_text') != '' || get_theme_mod( 'automotive_centre_email_address') != '') { ?>
            ...
            <div class="col-lg-10 col-md-12 col-9">
              ...
              <p><a href="mailto:<?php echo esc_attr(get_theme_mod('automotive_centre_email_address',''));?>"><?php echo esc_html(get_theme_mod('automotive_centre_email_address',''));?></a></p>
            </div>
          <?php }?>
        </div>
      </div>
