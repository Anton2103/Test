...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'automotive_centre_slider_hide_show', false) != '' || get_theme_mod( 'automotive_centre_resp_slider_hide_show', false) != '') { ?>
    <section id="slider">
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" data-bs-interval="<?php echo esc_attr(get_theme_mod( 'automotive_centre_slider_speed',4000)) ?>">
            ...
            <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  ...
                  <p class="wow bounceInDown" data-wow-duration="3s"><?php $excerpt = get_the_excerpt(); echo esc_html( automotive_centre_string_limit_words( $excerpt, esc_attr(get_theme_mod('automotive_centre_slider_excerpt_number','30')))); ?></p>
                  <?php if( get_theme_mod('automotive_centre_slider_button_text','LEARN MORE') != ''){ ?>
                    <div class="slider-btn wow bounceInDown" data-wow-duration="3s">
  ...
  <section id="about-section" class="wow zoomInUp delay-1000" data-wow-duration="2s">
    <div class="container">
