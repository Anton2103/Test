<?php
/**
 * Automotive Centre functions and definitions
 *
...
/* Theme Setup */
if ( ! function_exists( 'automotive_centre_setup' ) ) :
 
function automotive_centre_setup() {

	$GLOBALS['content_width'] = apply_filters( 'automotive_centre_content_width', 640 );
	
	load_theme_textdomain( 'automotive-centre', get_template_directory() . '/languages' );
	...
	add_image_size('automotive-centre-homepage-thumb',240,145,true);
	
    register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'automotive-centre' ),
	) );
	 ...
	 */
	add_editor_style( array( 'css/editor-style.css', automotive_centre_font_url() ) );
...
/* Theme Widgets Setup */
function automotive_centre_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Blog Sidebar', 'automotive-centre' ),
		'description'   => __( 'Appears on blog page sidebar', 'automotive-centre' ),
		'id'            => 'sidebar-1',
	...
	register_sidebar( array(
		'name'          => __( 'Page Sidebar', 'automotive-centre' ),
		'description'   => __( 'Appears on page sidebar', 'automotive-centre' ),
		'id'            => 'sidebar-2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Sidebar 3', 'automotive-centre' ),
		'description'   => __( 'Appears on blog page sidebar', 'automotive-centre' ),
		'id'            => 'sidebar-3',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Navigation 1', 'automotive-centre' ),
		'description'   => __( 'Appears on footer 1', 'automotive-centre' ),
		'id'            => 'footer-1',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Navigation 2', 'automotive-centre' ),
		'description'   => __( 'Appears on footer 2', 'automotive-centre' ),
		'id'            => 'footer-2',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Navigation 3', 'automotive-centre' ),
		'description'   => __( 'Appears on footer 3', 'automotive-centre' ),
		'id'            => 'footer-3',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Navigation 4', 'automotive-centre' ),
		'description'   => __( 'Appears on footer 4', 'automotive-centre' ),
		'id'            => 'footer-4',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
...
/* Theme Font URL */
function automotive_centre_font_url() {
	$font_url      = '';
	$font_family   = array();
...
function automotive_centre_scripts() {
	...
	wp_enqueue_script( 'automotive-centre-jquery-wow', esc_url(get_template_directory_uri()) . '/assets/js/wow.js', array('jquery') );
	wp_enqueue_style( 'automotive-centre-animate-css', esc_url(get_template_directory_uri()).'/assets/css/animate.css' );
...
function automotive_centre_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function automotive_centre_logo_title_hide_show(){
	if(get_theme_mod('automotive_centre_logo_title_hide_show') == '1' ) {
		return true;
	}
	return false;
}

function automotive_centre_tagline_hide_show(){
	if(get_theme_mod('automotive_centre_tagline_hide_show') == '1' ) {
		return true;
	}
	return false;
}
